...
In this project, I was able to  learn about object-relational mapping it's importance on
database scripting. Also familiar with MySQLdb and SQLAlchemy to
query, create, edit, and delete tables in MySQL using the following resources:
